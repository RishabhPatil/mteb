#!/usr/bin/env python3
"""Build and upload HMDB51 video pair classification for MTEB.

Samples balanced same-class / different-class video pairs from mteb/HMDB51
with a fixed seed (same logic as scripts/upload_video_pair_classification.py).

Hub dataset:
  - {repo-id}  (default: iamfortytwo/HMDB51-PC-V)

Usage:
  python scripts/data/hmdb51_pair_classification/create_data.py \
      --repo-id iamfortytwo/HMDB51-PC-V
"""
...
_SOURCE = "mteb/HMDB51"
_SOURCE_REVISION = "7f9af5438a855e9348fb23ecb5ec740a9c21daf3"
_SEED = 42
_MAX_PER_SIDE = 1024
...
def main() -> None:
    ...
    parser.add_argument("--repo-id", default="iamfortytwo/HMDB51-PC-V")
    parser.add_argument("--work-dir", type=Path, default=Path("/tmp/hmdb51_pc"))
